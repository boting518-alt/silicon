...
function App() {
  const [activePage,setActivePage]=useState<'crm'|CatalogPage>('crm');
  const pages:Record<string,'crm'|CatalogPage>={'客户管理':'crm','商品目录':'skus','包件 / BOM':'boms','价格维护':'price-books'};
